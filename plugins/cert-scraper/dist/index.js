...
import { parseCertRegistryCsv, findExpiringCerts } from "./csv-parser.js";
...
async function fetchRegistryCsv(baseUrl, state, orgType) {
...
export default defineToolPlugin({
    ...
    tools: (tool) => [
        tool({
            ...
            description: "Fetch certification audit records from a public registry. " +
            ...
            parameters: Type.Object({
                ...
                months_until_expiry: Type.Optional(Type.Number({
        ...
        tool({
            ...
            description: "Get summary statistics for certifications: counts by org type, status, and state.",
            parameters: Type.Object({
                states: Type.Array(Type.String(), {
